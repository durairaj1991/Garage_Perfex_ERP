...
function elFinderBrowser(e, t, a) {
    return (tinymce.activeEditor.windowManager.elfinderCallback = e), tinymce.activeEditor.windowManager.openUrl({ url: admin_url + "misc/tinymce_file_browser", title: app.lang.media_files, width: 900, height: 450 }), !1;
}
function init_editor(e, t) {
    ...
    if (0 !== a.length) {
        ...
        if (("true" == isRTL && ((i.directionality = "rtl"), i.plugins.push("directionality")), void 0 !== t)) for (var n in t) "append_plugins" != n ? (i[n] = t[n]) : i.plugins.push(t[n]);
...
function edit_note(e) {
    var t = $("body")
        ...
        .val();
    "" !== t &&
        ($.post(admin_url + "misc/edit_note/" + e, { description: t }).done(function (t) {
            (!0 !== (t = JSON.parse(t)).success && "true" != t.success) ||
...
function edit_task_comment(e) {
    ...
    t.next().addClass("hide"), t.removeClass("hide"), tinymce.remove("#task_comment_" + e);
    var a = _simple_editor_config();
    (a.auto_focus = "task_comment_" + e), (a.toolbar_sticky = !0), init_editor("#task_comment_" + e, a), tinymce.triggerSave();
}
...
function add_item_to_preview(e) {
    requestGetJSON("invoice_items/get_item_by_id/" + e).done(function (e) {
        clear_item_preview_values(),
            ...
            // $('.main select[name="long_description"]').val(e.long_description);
...
function clear_item_preview_values(e) {
    var t = $("table.items tbody").find("tr:last-child").find("select").selectpicker("val"),
        ...
        a.find('select[name="long_description"]').val(""),
        ...
        return (
            get_taxes_dropdown_template(l, e.taxname).done(function (a) {
                ...
                l.length > 0 &&
                    ...
                    (n +=
                        '<td class="item_discount"><input type="number" data-toggle="tooltip" title="' +
                        app.lang.item_field_not_formatted +
                        '" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' +
                        s +
                        '][item_discount]" value="' +
...
function calculate_total() {
    ...
    var e,
        ...
        z = $('input[name="labour_charge"]').val(),
    ...
    $(".tax-area").remove(),
        ...
        (d -= c),
        (m = parseFloat(m)),isNaN(m) || (d += m),
        (z = parseFloat(z)),isNaN(z) || (d += z);
    ...
    $('input[name="discount_total"]').val(accounting.toFixed(c, app.options.decimal_places)),
        ...
        $(".labour-charge").html(format_money(z));
...
function init_new_task_comment(e) {
    ...
    (t.toolbar_sticky = !0), (void 0 !== e && !1 !== e) || (t.auto_focus = !0);
...
function initializeTinyMceMentions(e, t) {
    ...
    (e.perfexCommands.getUsersForMention = async function () {
        ...
        let e = await t();
        return (a = e.map((e) => ({ value: e.id.toString(), text: e.name }))), a;
    }),
        (e.perfexCommands.insertMentionUser = function (t, a, i) {
            e.selection.setRng(i || 0), e.insertContent('<span class="mention" contenteditable="false" data-mention-id="' + t + '">@' + a + "</span>&nbsp;");
        }),
        e.ui.registry.addAutocompleter("mentions", {
            ...
            onAction: function (t, a, i) {
                e.perfexCommands.getUsersForMention().then((n) => {
                    ...
                    e.perfexCommands.insertMentionUser(i, s.text, a), t.hide();
                });
            },
        });
}
...
function add_template(e, t) {
    $("#modal-wrapper").load(admin_url + "templates/modal", { slug: "new", rel_type: e, rel_id: t }, function () {
        $("#TemplateModal").is(":hidden") && $("#TemplateModal").modal({ backdrop: "static", show: !0 }),
            ...
            init_editor("#content", { pagebreak_split_block: !0, contextmenu: "link image inserttable | cell row column deletetable | paste copy | pagebreak", append_plugins: "pagebreak" });
    });
}
...
$("body").on("loaded.bs.select change", "select.ajax-search", function (e) {
    ...
    $(function () {
        ...
        $("body").on("submit", "._transaction_form", function () {
            ...
            $("body").on("change", 'input[name="labour_charge"],select.tax', function () {
                calculate_total();
            }),
