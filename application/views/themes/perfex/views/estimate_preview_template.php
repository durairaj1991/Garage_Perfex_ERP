                                    ...
                                    <tbody>
                                        <tr id="subtotal">
                                            ...
                                            <td></td>
                                               <td></td>
                                            <td class="text-right">
                                                <span class="bold tw-text-neutral-700 text-right">
                                        ...
                                        <tr id="labour-charge">
                                            <td>
                                                <span class="bold tw-text-neutral-700 text-left">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span
                                                    class="text-right bold tw-text-neutral-700"><?php echo _l('estimate_discount'); ?>
